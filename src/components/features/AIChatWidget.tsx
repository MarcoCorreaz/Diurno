  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMsg: Message = {
        id: (Date.now() + 1).toString(),
        sender: "ai",
        text: "Dica Rituno IA: Para otimizar seu ritmo diário, separe atividades de foco analítico pela manhã, execução principal à tarde e desconexão à noite. Você também pode usar o botão 'Gerar Rotina com IA' no painel para criar hábitos automaticamente no seu Supabase!",
      };
